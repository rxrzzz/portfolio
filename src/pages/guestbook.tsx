...
export default function GuestBook() {
  ...
  return (
    <>
      <h1 className="my-16 mb-1 text-center  font-author text-4xl font-medium opacity-80 dark:opacity-100 lg:text-6xl">
        Guest Book
      </h1>
        ...
        {commentList &&
          commentList.map((data) => (
            <Fragment key={data.id}>
              <div className="mx-4 my-2 min-w-[200px] border p-2 text-left font-author shadow-md dark:shadow-white">
      ...
      <form className="fixed bottom-36 right-0 left-0 z-10 mx-auto flex min-h-[100px] max-w-[400px] resize-none justify-evenly rounded-xl ">
        <div className="relative mx-auto w-11/12">
          ...
          ></textarea>
          <button
            className="absolute bottom-4 right-2 h-8 w-8 rounded-md bg-black "
